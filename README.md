...
Install [cygwin](http://www.cygwin.com/) with wget (check wget in the installation process) then start cygwin and execute `wget --no-check-certificate https://raw.github.com/chriskjaer/oh-my-cygwin/master/oh-my-cygwin.sh -O - | sh`
